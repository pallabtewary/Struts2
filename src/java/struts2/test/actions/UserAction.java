...
// ShowUsers method
    ...
    public String updateUser() throws Exception {
        ...
        try {
            if (submitType.equals("updatedata")) {
                User user = admin.fetchUserDetails(userName.trim());
                if (user != null) {
                ...
                int i = admin.updateUserDetails(userName, password, firstName, lastName,
                        email, phoneNumber);
                if (i > 0) {
    ...
    public String deleteUser() throws Exception {
        Admin admin = new Admin();
        try {
            int isDeleted = admin.deleteUserDetails(userName);
            if (isDeleted > 0) {
